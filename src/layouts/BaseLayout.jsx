...
const BaseLayout = () => {
  return (
    <div className="gradient">
      {/* <div className="relative inset-0 -z-10 h-full max-w-[480px] mx-auto items-center [background:radial-gradient(140%_170%_at_50%_100%,#000_40%,#63e_100%)]"> */}

      {/* <div className="relative inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(140%_170%_at_50%_100%,#000_40%,#63e_100%)]"> */}
      {/* <div class="absolute inset-0 -z-10 h-full w-full items-center px-5 py-24 [background:radial-gradient(140%_170%_at_50%_140%,#000_40%,#63e_100%)]"> */}
      ...
      <footer className="text-white absolute w-full h-[84px] bottom-0 left-0">
        <div className="relative w-full h-[84px] border border-green-400">
          <BottomNav />
          {/* <div class="fixed z-50 w-full h-16 max-w-[248px] mb-[34px] -translate-x-1/2 bg-transparent backdrop-blur-md border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
            <div class="grid h-full max-w-lg grid-cols-4 mx-auto px-2">
